...
const AdminDashboard = () => {
    ...
    const statCards = [
        ...
        {
            label: "Damaged",
            value: stats?.totalDamagedBooks ?? 0,
            icon:  "🔨",
        ...
        <div className="font-serif text-[#e8e0d0]">
            ...
            {stats?.totalOverdueLoans > 0 && (
                <div className="bg-red-500/10 border border-red-500/20
                    rounded-xl p-4 mb-6 flex items-center
                ...
                >
                    <p className="text-sm text-red-400">
                        ...
                        {" "}with pending fines of{" "}
                        <span className="font-bold">
                            ₹{stats.totalPendingFineAmount?.toFixed(2)}
                        </span>
                    </p>
                    <button
            ...
            >
                {statCards.map((card, i) => (
                    <div
                        key={i}
                        className={`
                            ${card.bg} border rounded-2xl p-4
